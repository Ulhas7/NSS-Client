  ...
  return (
    ...
    <View style={{ display: 'flex', alignItems: 'center', width: '100%' }}>
      ...
      <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', height: '8%' }}>
        <TouchableOpacity
          style={{ flex: 1, margin: 5, backgroundColor: '#c5cacd', borderRadius: 18, justifyContent: 'center' }}
          onPress={() => {
            props.navigation.navigate('StudentList');
          }}>
          <Text style={{ textAlign: 'center', color: '#394047', fontSize: 16, fontWeight: '600', marginBottom: 10, marginTop: 10 }}>
            StudentList
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={{ flex: 1, margin: 5, backgroundColor: 'rgb(44 44 149)', borderRadius: 18 }}
          onPress={() => {
            props.navigation.navigate('Events');
          }}>
          <Text style={{ textAlign: 'center', color: 'white', fontSize: 16, fontWeight: '600', marginBottom: 10, marginTop: 10 }}>
            Events
          </Text>
        </TouchableOpacity>
      </View>
      ...
      />
      <View contentContainerStyle={{ flexGrow: 1 }} style={{ width: '95%', height: '68%' }}>
              ...
              .map((item, index) => (
                <View key={index} style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                  ...
                  <TouchableOpacity>
                    ...
                    <View>
                      <Text style={{ color: 'black', fontWeight: 'bold', fontSize: 12, padding: 10 }}>
